...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Thank you for registering with Okelcor. Please verify your email address by clicking the button below.</p>
        ...
        <div class="footer">
            ...
            <a href="{{ $verificationUrl }}" style="color:#e63946;word-break:break-all;">{{ $verificationUrl }}</a></p>
        </div>
    </div>
</body>
</html>
